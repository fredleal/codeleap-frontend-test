...
export function PostCard({ post, isOwner, onEdit, onDelete }: PostCardProps) {
  ...
  return (
    <div className="border border-[#999] rounded-2xl overflow-hidden">
      <div className="bg-[#7695EC] p-6 flex justify-between items-center">
        <h3 className="text-[22px] font-bold text-white truncate">{post.title}</h3>
      ...
      <div className="p-6">
        <div className="flex justify-between text-[#777] text-lg mb-4">
